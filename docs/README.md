...
- [Expedition state specification](./specs/expedition-state.md)
- [Buddy adapter specification](./specs/buddy-adapter.md)
- [Safety model](./specs/safety-model.md)
- [MVP task plan](./tasks/mvp.md)
