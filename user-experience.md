# The Guide: User Experience

## From opening the URL to returning home

From the moment the user opens the URL, The Guide feels like the opening of a strange mobile adventure game—not a signup flow or a chatbot.

The experience is designed for a phone held in one hand. The interface is portrait-first, illustrated, minimal, and focused on one meaningful moment at a time.
...
The user receives one achievable instruction at a time. The screen might show a single scene, a short piece of dialogue, and a few response choices:
...
The expedition follows a loose structure:

1. The invitation
2. The first movement
3. A discovery
4. A manageable challenge
5. A reward, clue, artifact, or insight
6. A return home

The user should never need to see this structure. It exists to give the experience shape and momentum.
